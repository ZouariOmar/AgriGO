...
// Fetch all users
$users = $db->query("SELECT * FROM Usrs");
?>
...
<html
	...
	<head>
		...
		<link
			rel="stylesheet"
			href="../../../vendor/libs/apex-charts/apex-charts.css" />
					...
					<div class="app-brand demo">
						<a href="index.html" class="app-brand-link">
							<span class="app-brand-logo demo">
								<img
									src="../../public/assets/imgs/favicons/favicon-16x16.png"
									width="60"
									alt="logo.png" />
							</span>
								...
								<li class="nav-item navbar-dropdown dropdown-user dropdown">
									<a
										...
										<div class="avatar avatar-online">
											<img
												src="../../public/assets/imgs/avatars/1.png"
												alt
					...
					<div class="content-wrapper">
						...
						<div class="container-xxl flex-grow-1 container-p-y">
										...
										<div class="d-flex align-items-end row">
											...
											<div class="col-sm-5 text-center text-sm-left">
												<div class="card-body pb-0 px-0 px-md-4">
													<img
														src="../../public/assets/imgs/illustrations/man-with-laptop-light.png"
														height="140"
														alt="View Badge User"
												...
												<div class="card-body">
													<div
														...
														<div class="avatar flex-shrink-0">
															<img
																src="../../public/assets/imgs/icons/unicons/chart-success.png"
																alt="chart success"
																class="rounded" />
														</div>
														<div class="dropdown">
											...
											<div class="card">
												<div class="card-body">
													<div
														...
														<div class="avatar flex-shrink-0">
															<img
																src="../../public/assets/imgs/icons/unicons/wallet-info.png"
																alt="Credit Card"
																class="rounded" />
														</div>
														<div class="dropdown">
											...
											<div class="card">
												<div class="card-body">
													<div
														...
														<div class="avatar flex-shrink-0">
															<img
																src="../../public/assets/imgs/icons/unicons/paypal.png"
																alt="Credit Card"
																class="rounded" />
														</div>
														<div class="dropdown">
											...
											<div class="card">
												<div class="card-body">
													<div
														...
														<div class="avatar flex-shrink-0">
															<img
																src="../../public/assets/imgs/icons/unicons/cc-primary.png"
																alt="Credit Card"
																class="rounded" />
														</div>
														<div class="dropdown">
							...
							<div class="row">
											...
											<div class="tab-content p-0">
												<div
													...
													<div class="d-flex p-4 pt-3">
														<div class="avatar flex-shrink-0 me-3">
															<img
																src="../../public/assets/imgs/icons/unicons/wallet.png"
																alt="User" />
														</div>
														<div>
										...
										<div class="card-body">
											<ul class="p-0 m-0">
												...
												<li class="d-flex mb-4 pb-1">
													<div class="avatar flex-shrink-0 me-3">
														<img
															src="../../public/assets/imgs/icons/unicons/chart.png"
															alt="User"
															class="rounded" />
													</div>
													<div
												...
												<li class="d-flex mb-4 pb-1">
													<div class="avatar flex-shrink-0 me-3">
														<img
															src="../../public/assets/imgs/icons/unicons/cc-success.png"
															alt="User"
															class="rounded" />
													</div>
													<div
												...
												<li class="d-flex">
													<div class="avatar flex-shrink-0 me-3">
														<img
															src="../../public/assets/imgs/icons/unicons/cc-warning.png"
															alt="User"
															class="rounded" />
													</div>
													<div
								...
								<div class="card col-md-6 col-lg order-3 mb-4">
												...
												foreach ($users as $usr) {
													echo '
														<tr>
															...
															<td>
        												<span class="badge ' .
														(($usr['Status'] === 'ACTIVE') ? "bg-label-success" :
															(($usr['Status'] === 'INACTIVE') ? "bg-label-danger" : "bg-label-warning")) .
														' me-1">
            											' . $usr['Status'] . '
        												</span>
    													</td>
															<td>
																<div class="dropdown">
																	...
																	<div class="dropdown-menu">
																		...
																		<a
																			class="dropdown-item"
																			href="../Controllers/delUsr.php?id=' . $usr['ID'] . '"
						...
						<footer class="content-footer footer bg-footer-theme">
							<div
								...
								<div class="mb-2 mb-md-0">
									...
									<a
										href="https://github.com/ZouariOmar/AgriGO/blob/main/LICENSE"
										target="_blank"
								...
								<div>
									...
									>
									<a
										href="https://www.linkedin.com/in/zouari-omar-143239283"
										target="_blank"
										class="footer-link me-4"
										>Linkedin</a
									>
									...
									<a
										href="https://github.com/ZouariOmar/AgriGO/blob/main/README.md"
										target="_blank"
										class="footer-link me-4"
										>Support</a
									>
