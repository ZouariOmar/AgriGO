...
<body>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                  <li class="nav-item">
                    <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-user me-1"></i> Partners</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="contracts.php?id=<?php echo $admin_id ?>"><i class="bx bx-pen me-1"></i>
                      Contracts</a>
                  </li>
                </ul>
              </div>
              ...
              <ul class="order-5">
                <div class="card col-lg order-4 mb-4">
                  <h5 class="card-header">Partners Table</h5>
                  <div class="table-responsive text-nowrap">
                    <table class="table table-hover">
                      ...
                      <tbody class="table-border-bottom-0">
                        <?php partners_table($partners, $admin_id); ?>
                      </tbody>
                    </table>
                  </div>
                </div>
  ...
  <div class="buy-now">
    <a href="addpartner.php?admin_id=<?php echo $admin_id; ?>" target="_blank"
      class="btn btn-danger btn-buy-now">Add New Partner</a>
  </div>
