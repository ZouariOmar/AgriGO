                                            ...
                                            <ul class="main-menu__list">
                                                <li class="dropdown current">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="Store.php?id=<?php echo isset($_GET['id']) ? htmlspecialchars($_GET['id']) : ''; ?>">Store</a></li>                                                        <li class="dropdown">
                                ...
                                <ul class="thumbnails">
                                    <li>
                                        <a href="#" class="thumbnail fix-box">
                                            <img class="changeimg" src="<?php echo safe_echo($product['image']); ?>" alt="<?php echo safe_echo($product['libelle']); ?>">
                                        </a>
                                    </li>
                                    <li class="image-additional">
                                        <a title="<?php echo safe_echo($product['libelle']); ?>" class="thumbnail"> 
                                            <img class="galleryimg" src="<?php echo safe_echo($product['image']); ?>" alt="<?php echo safe_echo($product['libelle']); ?>">
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div id="product">
                                    <div class="form-group">
                                        ...
                                        <form action="cart.php" method="post">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-lg btn-block reg_button" name="buy_now" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Buy Now</button>
                                        </form>
                                    </div>
                                </div>
                                <div class="rating">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="tab-content">
                                    <div id="tab-destination" class="tab-pane active">
                                        <div class="row">
                                            <input id="pac-input" type="text" placeholder="Search for a place" value="<?php echo htmlspecialchars($product['location']); ?>">
