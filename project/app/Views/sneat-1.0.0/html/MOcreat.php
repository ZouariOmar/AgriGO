...
>
  <head>
    ...
    <link rel="stylesheet" href="../assets/css/gr2.css" />
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active open">
              <a href="javascript:void(0)" class="menu-link menu-toggle">
                ...
                <div data-i18n="Extended UI">Modifie Offers</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item active">
                  <a href="MCindex.php" class="menu-link">
                    <div data-i18n="Perfect Scrollbar">Categorie</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="MOindex.php" class="menu-link">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Modifie Offers /</span> Offers
              </h4>

              <!-- the adding of the index.php -->
              <div class="container">
                  ...
                  <form method="post" action="../../../forms/HCO.php" id="offerForm">
                      ...
                      <div class="form-group" style="margin-bottom: 20px; text-align: left;">
                        <label for="categorie_id" style="display: block; font-size: 16px; margin-bottom: 8px; color: #155724;">Type</label>
                          <select id="categorie_id" name="categorie_id" required style="width: 100%; padding: 10px; font-size: 14px; border: 1px solid #c3e6cb; border-radius: 5px; background-color: #ffffff; color: #155724; appearance: none; -webkit-appearance: none; -moz-appearance: none; background-image: url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%22292.4%22%20height%3D%22292.4%22%3E%3Cpath%20fill%3D%22%23155724%22%20d%3D%22M287%2069.4a17.6%2017.6%200%200%200-13-5.4H18.4c-5%200-9.3%201.8-12.9%205.4A17.6%2017.6%200%200%200%200%2082.2c0%205%201.8%209.3%205.4%2012.9l128%20127.9c3.6%203.6%207.8%205.4%2012.8%205.4s9.2-1.8%2012.8-5.4L287%2095c3.5-3.5%205.4-7.8%205.4-12.8%200-5-1.9-9.2-5.5-12.8z%22%2F%3E%3C%2Fsvg%3E'); background-repeat: no-repeat; background-position: right 10px top 50%; background-size: 12px auto;">
                            <option value="" style="color: #6c757d;">Select Type</option>
                            <option value="1" style="color: #155724;">Job</option>
                            <option value="2" style="color: #155724;">Lending</option>
                            <option value="3" style="color: #155724;">Produce</option>
                          </select>
                        <div id="typeError" class="error-message" style="color: #dc3545; font-size: 14px; margin-top: 5px; display: none;"></div>
                      </div>
