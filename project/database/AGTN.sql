...
--
-- Host: localhost:3306
-- Generation Time: Dec 15, 2024 at 01:58 PM
...
(146, 60, '127.0.0.1', NULL, '127.0.0.1', 'localhost', 'HTTP/1.1', '2024-12-14 16:12:33', 'SUCCESS'),
(147, 60, '127.0.0.1', NULL, '127.0.0.1', 'localhost', 'HTTP/1.1', '2024-12-14 16:14:04', 'SUCCESS'),
(148, 60, '127.0.0.1', NULL, '127.0.0.1', 'localhost', 'HTTP/1.1', '2024-12-14 23:11:49', 'SUCCESS');
...
INSERT INTO `produit` (`id`, `id_categorie`, `libelle`, `prix`, `date_creation`, `description`, `image`, `location`, `Quantitie`, `user_id`) VALUES
(40, 18, 'orange', 8, '0000-00-00 00:00:00', '', 'Fiche-aliment-Images-36.jpg', NULL, 0, NULL),
(41, 18, 'mais', 5, '0000-00-00 00:00:00', '', 'download.jpg', NULL, 0, NULL),
(45, 20, 'agriculteure', 15, '0000-00-00 00:00:00', '15dt/H', 'submarine.png', NULL, 0, NULL),
(46, 20, 'pasta', 15, '0000-00-00 00:00:00', 'hfgqshfs', 'pasta.jpg', NULL, 0, NULL),
(47, 19, 'male', 15, '0000-00-00 00:00:00', 'f;sfd', '../upload/produit/675c1600479a7.jpg', NULL, 0, NULL),
(48, 20, 'aziz', 10, '0000-00-00 00:00:00', 'tafar', '../upload/produit/675c16355eca3.png', NULL, 0, NULL),
(49, 18, 'nike', 15, '0000-00-00 00:00:00', 'dsqds', '../upload/produit/675c172364c62.jpg', NULL, 0, NULL),
(50, 18, 'bza3 bheyim', 44, '0000-00-00 00:00:00', 'plkoijiuhiu ohhhh bza3', '', NULL, 0, NULL);
...
CREATE TABLE `rapports` (
  ...
  `Created_at` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Report creation date'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `rapports` (`Report_ID`, `category`, `subject`, `description`, `sta`, `Update_at`, `Created_at`) VALUES
(128, 'technical', 'zefoilhdksnqv', 'zooielg=sdfknqv<mù', 'DONE', '2024-12-14 23:16:46', '0000-00-00 00:00:00'),
(129, 'technical', 'zeflknds', 'zeflsqhjbgorleikd', 'DONE', '2024-12-15 00:01:03', '0000-00-00 00:00:00'),
(130, 'service', 'ddd', 'ddd', 'IN PROCESS', '2024-12-15 00:01:19', '0000-00-00 00:00:00'),
(131, 'service', 'ismail', 'ennaifer\r\n', 'RECIEVED', '2024-12-03 09:51:18', '0000-00-00 00:00:00'),
(138, 'technical', 'ok', 'ok', 'DONE', '2024-12-09 07:56:18', '0000-00-00 00:00:00'),
(140, 'service', 'Help me', 'hello mama', 'IN PROCESS', '2024-12-15 00:01:48', '2024-12-14 23:13:09');
...
--
ALTER TABLE `Login_History`
  MODIFY `Login_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for each login attempt', AUTO_INCREMENT=149;
...
--
ALTER TABLE `rapportstat`
  MODIFY `StatID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `produit`
  ADD CONSTRAINT `R06` FOREIGN KEY (`user_id`) REFERENCES `Usrs` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
