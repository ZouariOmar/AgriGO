...
(function () {
	...
	// --------------------------------------------------------------------
	const clients_count =
		parseFloat(document.getElementById("clients_count").value) || 0;
	const farmers_count =
		parseFloat(document.getElementById("farmers_count").value) || 0;
	const admins_count =
		parseFloat(document.getElementById("admins_count").value) || 0;
	const total_users = clients_count + farmers_count + admins_count;
	const chartOrderStatistics = document.querySelector("#orderStatisticsChart"),
		orderChartConfig = {
			...
			labels: ["Clients", "Farmers", "Admins"],
			series: [
				Math.round((clients_count / total_users) * 100 * 100) / 100,
				Math.round((farmers_count / total_users) * 100 * 100) / 100,
				Math.round((admins_count / total_users) * 100 * 100) / 100,
			],
			colors: [
