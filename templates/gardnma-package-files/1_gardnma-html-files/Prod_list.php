                                            ...
                                            <div class="panel-body">
                                                <div class="infoBoxContainer">  
                                                    ...
                                                    <div class="infoBoxContents" id="sidebar">
                                                        ...
                                                        <a href="single-Prod.html">Lorem Simply</a><br />€21.00
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="collapseFour" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <div class="infoBoxContents" id="sidebar">
                                                    ...
                                                    <a href="single-Prod.html">Lorem Big Block</a><br /><del></del>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="btn-group hidden-xs">
                                        ...
                                        <a class="btn btn-default" id="grid-view" href="Prod.html"><i class="fa fa-th"></i></a>   
                                    </div>
                                </div>
                            ...
                            <div class="row margin-top">
                                <div class="product-layout product-list col-xs-12">
                                    <div class="product-thumb">
                                        <div class="image"><a href="single-Prod.html"><img class="img-responsive"  src="images/d26.jpg" width="200" height="200"></a></div>
                                        <div class="product-details-box" style="overflow: hidden">
                                            <div class="caption">
                                                <h4 class="product_title"><a href="single-Prod.html">Lorem small</a></h4>
                                                <p>
                                ...
                                <div class="product-layout product-list col-xs-12">
                                    <div class="product-thumb">
                                        <div class="image"><a href="single-Prod.html"><img class="img-responsive"  src="images/d15.jpg" width="200" height="200"></a></div>
                                        <div class="product-details-box" style="overflow: hidden">
                                            <div class="caption">
                                                <h4 class="product_title"><a href="single-Prod.html">SIMPHNY</a></h4>
                                                <p>
                                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry....</p>
                                                <p class="price">
                                ...
                                <div class="product-layout product-list col-xs-12">
                                    <div class="product-thumb">
                                        <div class="image"><a href="single-Prod.html"><img class="img-responsive"  src="images/d21.jpg" width="200" height="200"></a></div>
                                        <div class="product-details-box" style="overflow: hidden">
                                            <div class="caption">
                                                <h4 class="product_title"><a href="single-Prod.html">Lorem block</a></h4>
                                                <p>
                                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry....</p>
                                                <p class="price">
