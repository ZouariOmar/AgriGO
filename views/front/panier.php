...
<div class="container py-2">
    ...
    // Check if the session variable is set, if not, set to 0
    $idUtilisateur = isset($_SESSION['utilisateur']['id']) ? $_SESSION['utilisateur']['id'] : 0;
    
    // Check if the cart array is set for the user, if not, set to an empty array
    $panier = [];
            ...
            if (empty($panier)) {
                if (!isset($_GET['success'])) {
                    ...
                    <div class="alert alert-warning" role="alert">
                        ...
                        Commençez vos achats <a class="btn btn-success btn-sm" href="./index.php">Acheter des produits</a>
                    </div>
                    <?php
                }
            } else {
